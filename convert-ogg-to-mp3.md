...
description: Convert OGG to MP3 without uploading file to backend. Fast, private, browser-based audio converter.
---
...
<div style="width: 100%; margin: auto; padding: 1rem; font-family: sans-serif;">
    ...
    <div style="display: flex; justify-content: center; margin-top: 2rem; width: 100%;">
        ...
        <input type="file" id="audio-file" accept=".ogg" style="display: none;">
    </div>
    <!-- File Info -->
    <div id="file-info"
