...
function convertToXML(){
    ...
    const finalXML = `<root>\n${xml}\n</root>`;
    const formattedXML = vkbeautify.xml(finalXML);

    document.getElementById("xml-viewer").style.display = 'flex';
    document.getElementById("xml-viewer").textContent = formattedXML;
